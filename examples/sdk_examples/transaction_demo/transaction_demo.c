...
int main(void) {
    ...
    // Initialize a MicroSuiTransaction object from setHarcodedTxBytes
    printf("\n\tCreating TX1: a MicroSuiTransaction object from hardcoded bytes (previosly generated by Sui Typescript SDK)...\n");
    MicroSuiTransaction tx = setHarcodedTxBytes(message_string);
    ...
    // Initialize a MicroSuiTransaction object from build
