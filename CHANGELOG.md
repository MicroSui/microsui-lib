...
- Added Ed25519 signature verification support (`microsui_verify_signature_ed25519` and `microsui_verify_signature`).
- Added usage examples covering all supported signing and verification use cases.
